...
botonVerificar.addEventListener("click", function () {
    let respuestaUsuario = campoRespuesta.value; // EL INPUT DEL FORMULARIO CONVERTIDO A VARIABLE PARA ALMACENARLO
    ...
    if (intentosRestantes === 0) {
        ...
        window.location.href = "https://mossos.gencat.cat/ca/inici"; // Redirige a la web de los Mossos 
    }
});
